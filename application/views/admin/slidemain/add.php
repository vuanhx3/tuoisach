<?php $this->load->view('admin/slidemain/head', $this->data); ?>
		...
		<fieldset>
			<div class="widget">
				<div class="title">
					...
					<h6>
					<i aria-hidden="true" class="fa fa-star-o"></i>Thêm mới Slide</h6>
				</div>
               ...
               <!-- Các tap hiển thị --> 
				...
				<div class="tab_container">
					 <div class="tab_content pd0" id="tab1" style="display: block;">
						...
						<div class="formRow">
							<label for="param_info" class="formLeft">Mô tả:<span class="req"></span></label>
    							<div class="formRight">
    								<span class="oneTwo">
    								  <input _autocheck="true" value="<?php echo set_value('info') ?>" id="param_info" name="info" type="text">
    								</span> 
    								<span class="autocheck" name="info_autocheck">(* Trường mô tả tối đa là 100 kí tự *)</span>
