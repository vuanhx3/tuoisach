...
<div class="col-lg-12">
  <div class="header_breadcrumb" >
    <ul class="breadcrumbs">
      ...
      <!-- blog -->
      <li> <i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp; <a href="<?php echo site_url('news'); ?>">Nạn thực phẩm bẩn tràn lan</a></li>
                       ...
                       <?php foreach($list_meovat as $val): ?> 
                        <?php $name = $val->slug; ?>
                          ...
                          <div class="content-box-mini">
                              <a href="<?php echo base_url($name.'/meo-vat-'.$new_info->id.'.html'); ?>" class="new-item-mini-image">
                                <img src="<?php echo $val->image_link ?>" alt="<?php echo $val->title ?>">
                              </a>
                              <a href="<?php echo base_url($name.'/meo-vat-'.$new_info->id.'.html'); ?>" class="new-item-mini-title">
                    ...
                    <div class="content-box">
                        ...
                        <?php if(count($tag) > 0): ?>
                        	  <?php foreach($tag as $val): ?>
              						    <li><a href="<?php echo base_url($name.'/tin-tuc-'.$new_info->id.'.html'); ?>" class="tag"><?php echo $val ?></a></li>
              						  <?php endforeach; ?>
                       <?php else: ?>
                           <?php echo ""; ?>
                       <?php endif; ?>
    ...
    <div class="content-product">
    	<article class="content-detail">
              ...
              <div class="article-related"><!-- hien thi cac bai viet khác -->
                      ...
                      <?php foreach($safety_article as $val): ?>
                         <?php $name = $val->slug; ?>
                        <?php if($val->id != $new_info->id): ?>
                            <div class="col-lg-4 col-md-4 article-new-box">
                                <a href="<?php echo base_url($name.'/tin-tuc-'.$val->id.'.html'); ?>" class="owl-new-item-image">
                                  <img src="<?php echo $val->image_link ?>" alt="<?php echo $val->title ?>">
                                </a>

                                <a href="<?php echo base_url($name.'/tin-tuc-'.$val->id.'.html'); ?>" class="owl-news-item__name">
                                   <h3><?php echo $val->title ?></h3>
                                </a>
                                ...
                                <div class="owl-news-item__summary">
                                  <p><?php echo $val->intro ?><a href="<?php echo base_url($name.'/tin-tuc-'.$val->id.'.html'); ?>">&nbsp;[Đọc tiếp]</a></p>
                                </div>
                            </div><!-- end col-lg-4 -->
                        <?php endif; ?>
                      <?php endforeach; ?>
