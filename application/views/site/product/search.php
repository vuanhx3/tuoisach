...
<div class="header_breadcrumb">
	<ul class="breadcrumbs">
	    ...
	    <li class="active breadcrumb-title"> <i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp; <?php echo isset($key)? $key : ''; ?> </li>
	</ul>
	...
	<div id="box_sanphammoi" style="width:100%;  float:left;margin-bottom:15px; margin:0 auto; padding-bottom: 20px;">
		...
		<div class="content-product">
			      <!-- danh sach thuvc pham theo danh muc -->
					      ...
					      <div class="search_form"><!-- the search -->
			                <form method="get" action="<?php echo site_url('product/search'); ?>">
			                  ...
			                  <button type="submit" class="search_form_submit"></button>
			                </form>
			             </div><!-- End search -->
