        ...
        <fieldset>
            <div class="widget">
                <div class="title">
                    ...
                    <h6> Chỉnh sửa thực phẩm / Mục có (*) là mục bắt buộc</h6>
                </div>
                 ...
                 <div class="tab_content pd0" id="tab1" style="display: block;">
                    <!-- truogn ten thuc pham -->
                       <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input type="text" value="<?php echo $product->name  ?>" _autocheck="true" id="param_name" name="name"></span>
                    ...
                    <!-- truong the loai thuc pham -->
                                        ...
                                        <?php if(count($row->subs) >= 1): ?>
                                            <optgroup label="<?php echo $row->name ?>">
                                                ...
                                                <?php foreach($row->subs as $subs): ?>
                                                    <option <?php if($subs->id == $product->catalog_id) echo 'selected'; ?> value="<?php echo $subs->id ?>"> <?php echo $subs->name ?> </option>
                                                <?php endforeach; ?>     
                                            </optgroup>
                                        <?php else: ?>    
                                            <!-- mac dinh se la danh muc con -->
                                            <option <?php if($subs->id == $product->catalog_id) echo 'selected'; ?> value="<?php echo $row->id ?>"> <?php echo $row->name ?> </option>
                                        <?php endif; ?>
                                      <?php endforeach; ?>
                                </select>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><input type="text" value="<?php echo $product->slug  ?>" _autocheck="true" id="param_slug" name="slug"></span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <div class="left">
                                    ...
                                    <input type="text" name="image" id="image" value="<?php echo $product->image_link  ?>" size="70">
                                    <?php if($product->image_link != ''): ?>
                                    <img src="<?php echo $product->image_link ?>"  width="200px" height="130px;" alt=""  style="display: block">
                                    <?php endif ?>
                       ...
                       <?php $image_list = json_decode($product->image_list);?>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <div class="left">
                                    <input type="text" name="image_list[]" id="<?php echo 'image_list' . $key ?>" value="<?php echo $value ?>" size="70">
                                    <img src="<?php echo $value ?>" width="150px" alt=""  style="display: block">
                                </div>
                            ...
                            <span class="add-image btn-add-image">Thêm ảnh</span>
                            <div class="clear"></div>
                        </div>
                        <script>
                        ...
                        <div class="formRow">
                            <label for="param_name" class="formLeft">Số lượng thực phẩm trong kho:<span class="req">*</span></label>
                                <div class="formRight">
                                    <span class="oneTwo">
                                      <input style="width:100px;" class="format_number" maxlength="6" placeholder="đơn vị kg" _autocheck="true" value="<?php echo $product->number_pd ?>" id="param_number_pd" name="number_pd" type="text"> (kg)  
                                    </span> 
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo">
                                    <input _autocheck="true" placeholder=".....vnđ" class="format_number" value="<?php echo $product->price ?>" id="param_price" style="width: 100px" name="price" type="text" maxlength="11"> 
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo">
                                    <input _autocheck="true" placeholder=".....vnđ" class="format_number" value="<?php echo $product->discount ?>" id="discount" style="width: 100px" name="discount" type="text" maxlength="11"> 
                       ...
                       <!-- truong nguon goc  -->
                                ...
                                <select name="partner_id"  class="left" >
                                    <option style="color: blue; font-weight: bold; value="">---------- Nguồn TP từ đối tác ----------</option> 
                                      <?php foreach($partner as $row): ?>
                                        <option <?php if($product->partner_id == $row->id) echo 'selected="selected"'; ?> value="<?php echo $row->id ?>"> <?php echo $row->title ?> </option>
                                      <?php endforeach; ?>
                                </select>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo"><textarea cols="" rows="4" _autocheck="true" id="param_gifts" name="gifts"><?php echo $product->gifts ?></textarea></span>
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <select name="noi_bat" id="noi_bat">
                                    <option <?php if($product->noi_bat == 0) echo 'selected="slected"' ?> value="0">Không</option>
                                    <option <?php if($product->noi_bat == 1) echo 'selected="slected"' ?> value="1">Có</option>
                                </select>
                     ...
                     <div class="tab_content pd0" id="tab2" style="display: none;">
                        <!-- truong site_title -->
                            <div class="formRow">
                                ...
                                <div class="formRight">
                                    <span class="oneTwo">
                                      <textarea cols="" rows="4" _autocheck="true" id="param_site_title" name="site_title">
                                          <?php echo $product->site_title ?>
                                      </textarea>
                                    </span>
                    ...
                    <div class="tab_content pd0" id="tab3" style="display: none;">
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <span class="oneTwo">
                                    <textarea cols="" rows="4" _autocheck="true" id="param_iframe" name="nhung_video">
