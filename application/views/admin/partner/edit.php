        ...
        <fieldset>
            <div class="widget">
                <div class="title">
                    ...
                    <h6> Cập nhật thông tin đơn vị đối tác  </h6>
                </div>
                ...
                <div class="tab_container">
                 ...
                 <div class="tab_content pd0" id="tab1" style="display: block;">
                    <!-- truogn ten meo vat -->
                       <div class="formRow">
                            <label for="param_title" class="formLeft">Tên đối tác:<span class="req">*</span></label>
                            <div class="formRight">
                        ...
                        <div class="formRow">
                            ...
                            <div class="formRight">
                                <div class="left">
                                  ...
                                  <?php endif; ?>
                                    <p>Để hiển thị tốt kích thước ảnh tối thiểu <b style="color: #FF0000;">420 X 240</b></p>
                                </div>
                        ...
                        <script>
                         ...
                         <div class="formRow">
                            ...
                            <div class="formRow"><!-- truong trang thai -->
                                ...
                                <div class="formRight">
                                    <label for="anhien">
                                        <input <?php if($info->anhien == 1) echo 'checked="checked"' ?> type="radio" name="anhien" value="1"> Hiện
                                    </label>
                                    <label for="anhien">
                                        <input <?php if($info->anhien == 0) echo 'checked="checked"' ?> type="radio" name="anhien" value="0"> Ẩn
                                    </label>
                                    <div class="clear error" name="meta_key_error"><?php echo form_error('anhien') ?></div>
                                </div>
                                <div class="clear"></div>
                            </div>
                             
                             <div class="formRow"><!-- truong lien ket muc thong tin -->
                                  <label for="param_name" class="formLeft">Liên kết tới mục: </label>
                                  <div class="formRight">
                                    <span class="oneTwo">
                                        <select _autocheck="true" id="param_info"  name="info">
                                             <?php foreach($list_info as $row): ?>
                                               <option <?php echo ($row->id == $info->info_id) ? 'selected' : '' ; ?> value="<?php echo $row->id ?>"> <?php echo $row->title ?> </option>
                                             <?php endforeach;?>  
                                        </select>
                                    </span>
