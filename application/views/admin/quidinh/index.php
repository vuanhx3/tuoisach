<?php $this->load->view('admin/quidinh/head', $this->data);?>

<div id="main_quidinh" class="wrapper">
    <br>
    <!--  Load thông báo -->
    ...
    <div class="widget">
        <div class="title">
            ...
            <h6> <i class="fa fa-book fa-2x" aria-hidden="true"></i> Chuyên đề tin qui định và chính sách cửa hàng</h6>
            <div class="num f12">
        ...
        <table id="checkAll" class="sTable mTable myTable" width="100%"
            ...
            <thead class="filter">
                <tr>
                    <td colspan="9">
                        <form method="get" action="<?php echo admin_url('quidinh'); ?>" class="list_filter form">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 180px">
                                          ...
                                          <input
                                            onclick="window.location.href = '<?php echo admin_url('quidinh'); ?>'; " value="Reset"
            ...
            <thead>
                <tr>
                    ...
                    <td style="width: 200px;">Tên bài viết</td>
                ...
                <tr>
                    <td colspan="9">
                        <div class="list_action itemActions">
                            <a url="<?php echo admin_url('quidinh/delete_all');?>" class="button blueB" id="submit" href="#submit"> <span
              ...
              <?php foreach($list as $row): ?>
                    <tr class="row_<?php echo $row->id?>">
                        ...
                        <td style="width:430px;">
                            ...
                            <div class="quidinh_title">
                                <a target="_blank" href="<?php echo admin_url('quidinh/edit/'.$row->id); ?>" class="tipS" original-title=""> <b><?php echo $row->title?></b>
                                 </a>
                                    <br>
                        ...
                        <td class="option textC">
                            ...
                            <a class="tipS" href="<?php echo admin_url('quidinh/edit/'.$row->id); ?>" original-title="Chỉnh sửa"> <img src="<?php echo public_url()?>/admin/images/icons/color/edit.png"></a> 
                            
                            <a class="tipS verify_action" href="<?php echo admin_url('quidinh/delete/'.$row->id); ?>" original-title="Xóa"> <img src="<?php echo public_url()?>/admin/images/icons/color/delete.png"> </a>
                        </td>
                    </tr>
                <?php endforeach; ?>    
            </tbody>
...
<script language="javascript">
       $(document).ready(function(){
            $('.view_content').on('click', function(){
               ...
               /*xu ly ajax*/
               $.ajax({
                    url: '<?php echo admin_url('quidinh/viewcontent') ?>',
                    type: 'post',
                    data: {
                      'id' : id
                    },
