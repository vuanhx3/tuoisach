...
<div class="wrapper">
    <!-- Form -->
    <form enctype="multipart/form-data" method="post" action="<?php echo admin_url('quidinh/add'); ?>" id="form" class="form">
        <fieldset>
            <div class="widget">
                <div class="title">
                    <img class="titleIcon" src="<?php echo public_url('admin')?>/images/icons/dark/add.png">
                    <h6> Thêm mới tin qui định và chính sách  </h6>
                </div>
                         ...
                         <div class="formRow">
                            ...
                            <div class="formRow"><!-- truong trang thai -->
                             ...
                             <div class="formRow"><!-- truong the tag -->
                                ...
                                <div class="formRight">
                                   <p>
                                       <input id="tags_2" type="text" name="tags[]" class="tags" value="" />
                                   </p>                             
                                </div>
                                <div class="clear"></div>
                            </div>
