...
<div class="col-lg-12">
  <div class="header_breadcrumb" >
    <ul class="breadcrumbs">
      ...
      <!-- blog -->
      <li class="active breadcrumb-title"> <i class="fa fa-angle-right" aria-hidden="true"></i>&nbsp; Mẹo nhỏ nơi góc bếp</li>
    </ul>
  </div>   
</div>
...
<div id="box_sanphammoi" style="width:100%;  float:left;margin-bottom:15px; margin:0 auto; padding-bottom: 20px;">
    ...
    <div class="content-product">
          <h1 class="blog-title">Mẹo vặt & Kỹ năng</h1>  

          <div class="blog-articles">
              <div class="row">
                   <div class="col-lg-12">

                      <?php foreach($list_meo as $val): ?>
                        <?php $name = $val->slug; ?>
                        <?php if($val->status == 1): ?>
                          <article class="article-item">
                              <a href="<?php echo base_url($name.'/meo-vat-'.$val->id.'.html'); ?>" class="article-item-image">
                                <img src="<?php echo $val->image_link ?>" alt="<?php echo $val->title ?>">
                              </a>

                              <a href="<?php echo base_url($name.'/meo-vat-'.$val->id.'.html'); ?>" class="article-item-name">
                                <h3><?php echo $val->title ?></h3>
                              </a>
