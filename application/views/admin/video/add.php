		...
		<form enctype="multipart/form-data" method="post" action="" id="form" class="form">
			<fieldset>
				<div class="widget">
				    <div class="title">
  						...
  						<h6>Thêm mới thông tin video</h6>
					  </div><!-- end title -->
      	...
      	<div class="tab_container">
              ...
              <div class="formRow">
                  ...
                  <div class="formRight">
                    <span class="oneTwo">
                    <input type="text" _autocheck="true" id="param_site_title" name="name" value="<?php echo set_value('name') ?>">
                    </span>
              ...
              <div class="formRow">
                ...
                <div class="formRight">
                  <div class="left">
                      <input type="text" name="image" id="image" value="<?php echo set_value('image') ?>" size="50">
              ...
              <div class="formRow">
                  ...
                  <div class="formRight">
                      <select name="catalog"  class="left" >
                          <option  style="color: blue; font-weight: bold;" value="">CHỌN LOẠI THỰC PHẨM</option> 
