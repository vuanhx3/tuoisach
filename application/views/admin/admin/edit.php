		...
		<fieldset>
			<div class="widget">
				<div class="title">
					...
					<h6>
						<i class="fa fa-user-plus" aria-hidden="true"></i> Chỉnh sửa quản trị viên
					</h6>
				</div>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input _autocheck="true" id="param_username" value="<?php echo $info->username ?>" name="username" type="text"></span> 
                ...
                <div class="formRow">
                    ...
                    <div class="formRight">
                        <div class="left">
                            ...
                            <input type="text" style="width:200px; margin-right:0px;" name="image" id="image" value="<?php echo $info->image_link  ?>" size="70">
                        </div>
                        <div class="right">
                        	<?php if($info->image_link != ''): ?>
                            <img src="<?php echo $info->image_link ?>" width="150px" height="130px;" alt=""  style="display: block">
                            <?php endif ?>
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo">
						   <input _autocheck="true" id="param_password" name="password" type="password">
						   <p style="color: red; font-style: italic">Nếu cập nhật mật khẩu thì mới nhập giá trị</p>
						</span> 
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo">
							<input _autocheck="true" style="width: 150px;" value="<?php echo $info->date ?>" id="param_date" name="date" type="date" min="1980-12-31" max="2000-01-02">
						</span> 
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input _autocheck="true" id="param_address" value="<?php echo $info->address ?>" name="address" type="text"></span> 
				...
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo">
						  <input _autocheck="true" placeholder="abc.address@gmail.com" id="param_emails" value="<?php echo $info->emails ?>" name="emails" type="text">
						</span> 
			   ...
			   <!-- Trường phone -->
				<div class="formRow">
					...
					<div class="formRight">
						<span class="oneTwo"><input _autocheck="true" id="param_phone" value="<?php echo $info->phone?>" name="phone" type="text"></span> 
					...
					<div class="formRow">
	                    ...
	                    <div class="formRight">
	                        <select name="admin_group_id" id="level" class="left" >
	                         <option <?php if($info->admin_group_id == 1) echo 'selected="selected"' ?> value="1"> root admin  </option>
	                        </select>
					...
					<div class="formRow">
	                    ...
	                    <div class="formRight">
	                        <select name="admin_group_id" id="level" class="left" >
	                         ...
	                         <option <?php if($info->admin_group_id == 2) echo 'selected="selected"' ?> value="2"> admin  </option>
	                         <option <?php if($info->admin_group_id == 3) echo 'selected="selected"' ?> value="3"> editor </option>
	                        </select>
	                        <span class="autocheck" name="cat_autocheck"></span>
						...
						<?php foreach($config_permissions as $controller => $actions): ?>
							...
							<div class="permission">
								...
								<?php foreach($actions as $sub): ?>
									<label  for=""> <input class="checkbox" type="checkbox" name="permissions[<?php echo $controller ?>][]" value="<?php echo $sub ?>" <?php echo (in_array($sub, $permissions_sub)) ? 'checked' : '' ?> /> <?php echo $sub ?> </label>
								<?php endforeach; ?>
							</div>
						<?php endforeach; ?>
					</div><!-- end formRight -->
