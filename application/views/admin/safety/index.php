<?php $this->load->view('admin/safety/head', $this->data);?>

<div id="main_safety" class="wrapper">
    <br>
    <!--  Load thông báo -->
    ...
    <div class="widget">
        ...
        <table id="checkAll" class="sTable mTable myTable" width="100%"
            ...
            <thead class="filter">
                <tr>
                    <td colspan="9">
                        <form method="get" action="<?php echo admin_url('safety'); ?>" class="list_filter form">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 180px">
                                          ...
                                          <input
                                            onclick="window.location.href = '<?php echo admin_url('safety'); ?>'; " value="Reset"
                ...
                <tr>
                    <td colspan="9">
                        <div class="list_action itemActions">
                            <a url="<?php echo admin_url('safety/delete_all');?>" class="button blueB" id="submit" href="#submit"> <span
                    ...
                    <tr class="row_<?php echo $row->id?>">
                        ...
                        <td style="width:460px;">
                            ...
                            <div class="safety_title">
                                <a target="_blank" href="<?php echo admin_url('safety/edit/'.$row->id); ?>" class="tipS" original-title=""> <b><?php echo $row->title?></b>
                                 </a>
                                    <br>
                        ...
                        <td class="option textC">
                            ...
                            <a class="tipS" href="<?php echo admin_url('safety/edit/'.$row->id); ?>" original-title="Chỉnh sửa"> <img src="<?php echo public_url()?>/admin/images/icons/color/edit.png"></a> 
                            
                            <a class="tipS verify_action" href="<?php echo admin_url('safety/delete/'.$row->id); ?>" original-title="Xóa"> <img src="<?php echo public_url()?>/admin/images/icons/color/delete.png"> </a>
                        </td>
                    </tr>
                <?php endforeach; ?>    
            </tbody>
...
<script language="javascript">
       $(document).ready(function(){
            $('.view_content').on('click', function(){
               ...
               /*xu ly ajax*/
               $.ajax({
                    url: '<?php echo admin_url('safety/viewcontent') ?>',
                    type: 'post',
                    data: {
                      'id' : id
                    },
