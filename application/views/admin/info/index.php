...
<div id="main_info" class="wrapper">
    ...
    <div class="widget">
        <div class="title">
            ...
            <h6> <i class="fa fa-book fa-2x" aria-hidden="true"></i> Chuyên đề thông tin cửa hàng</h6>
            <div class="num f12">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="width: 180px">
                                          ...
                                          <input
                                            onclick="window.location.href = '<?php echo admin_url('info'); ?>'; " value="Reset"
                ...
                <tr>
                    <td colspan="9">
                        <div class="list_action itemActions">
                            <a url="<?php echo admin_url('info/delete_all');?>" class="button blueB" id="submit" href="#submit"> <span
                    ...
                    <tr class="row_<?php echo $row->id?>">
                        ...
                        <td style="width:430px;">
                            ...
                            <div class="info_title">
                                <a target="_blank" href="<?php echo admin_url('info/edit/'.$row->id); ?>" class="tipS" original-title=""> <b><?php echo $row->title?></b>
                                 </a>
                                    <br>
                        ...
                        <td class="option textC">
                            ...
                            <a class="tipS" href="<?php echo admin_url('info/edit/'.$row->id); ?>" original-title="Chỉnh sửa"> <img src="<?php echo public_url()?>/admin/images/icons/color/edit.png"></a> 
                            
                            <a class="tipS verify_action" href="<?php echo admin_url('info/delete/'.$row->id); ?>" original-title="Xóa"> <img src="<?php echo public_url()?>/admin/images/icons/color/delete.png"> </a>
                        </td>
                    </tr>
                <?php endforeach; ?>    
            </tbody>
...
<script language="javascript">
       $(document).ready(function(){
            $('.view_content').on('click', function(){
               ...
               /*xu ly ajax*/
               $.ajax({
                    url: '<?php echo admin_url('info/viewcontent') ?>',
                    type: 'post',
                    data: {
                      'id' : id
                    },
